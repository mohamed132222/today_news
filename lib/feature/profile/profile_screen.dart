                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildProfileItem(
                      ...
                      onTap: () async {
                        // Clear user data from Hive via UserRepository
                        await UserRepository().clearUser();
                        // Clear user data from Shared Preferences
                        await PreferencesManager().clear();

                        // Update login flag in Shared Preferences
                        await PreferencesManager().setBool("is_login", false);
  ...
  Widget _buildProfileItem({
    ...
    return Column(
      children: [
        ...
        if (hasDivider) const Divider(color: Color(0xFFD1DAD6), thickness: 1.5),
      ],
    );
  }
}
